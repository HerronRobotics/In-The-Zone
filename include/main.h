...
/**
 * Task to manage the LCD screen. Flashes if the autonomous mode is not set, and can switch between
 * displaying the active autonomous, battery level, match progress, debug, and more.
 */
void lcdControl();
...
/**
 * Motor control task. Responsible for groups, pid, etc.
 */
void motorControl();
